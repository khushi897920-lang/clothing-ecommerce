...
export default function MenCollectionPage() {
  ...
  useEffect(() => {
    ...
    if (selectedCategory && selectedCategory !== "All Men") {
  ...
  }, [selectedCategory, selectedSizes, selectedColors, priceMax, sortBy]);
  ...
  }, [products, selectedCategory, priceMax, selectedSizes, inStock, outOfStock]);
